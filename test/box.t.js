...
function prove (okay) {
    ...
    {
        const a = new Box(0, 5, 0, 5)
        const b = new Box(0, 7, 0, 7)
        const c = new Box(5, 10, 5, 10)
        const d = new Box(15, 5, 0, 20)
        const e = new Box(-20, 10, -20, 10)

        okay(a.combine(b), b, "Combined (0, 5, 0, 5) and (0, 7, 0, 7)" )
        okay(b.combine(c), new Box(0, 10, 0, 10), "Combined (0, 5, 0, 5) and (0, 7, 0, 7)" )
        okay(c.combine(d), new Box(5, 10, 0, 20), "Combined (0, 5, 0, 5) and (0, 7, 0, 7)" )
        okay(e.combine(d), new Box(-20, 10, -20, 20), "Combined")
    }

    {
        const a = new Box(-10, 5, -5, 0)
        const b = new Box(0, 7, 0, 7)
    ...
    {
        const a = new Box(0, 5, 2, 5)
        const b = new Box(0, 7, 0, 7)
        const c = new Box(5, 10, 5, 10)
        const d = new Box(15, 5, 0, 20)
        const e = new Box(-5, 5, -3, 2)

        okay(b.intersect(a), new Box(0, 5, 2, 5), "Intersect of (0, 5, 2, 5) and (0, 7, 0, 7) is (0, 5, 2, 5)")
        okay(a.intersect(c), new Box(5, 5, 5, 5), "Intersect of (0, 5, 7, 5) and (5, 10, 5, 10) is (5, 5, 7, 5)")
        okay(b.intersect(c), new Box(5, 7, 5, 7), "Intersect of (0, 7, 0, 7) and (5, 10, 5, 10) is (5, 7, 5, 7)")
        okay(c.intersect(d), null, "Intersect of (5, 10, 5, 10) and (15, 5, 0, 20) is null")
        okay(e.intersect(a), new Box(0, 5, 2, 2), "Intersect of (0, 5, 2, 5) and (-5, 5, -3, 2) is (0, 5, 2, 2)")
    }
...

    {
        ...
        area = new Box(-Infinity, Infinity, -Infinity, Infinity)

        okay(area.splitX(5), [
            new Box(-Infinity, Infinity, -Infinity, 5),
            new Box(5, Infinity, -Infinity, Infinity)
...

    {
        ...
        okay(area.splitY(10), [
            new Box(-Infinity, 10, -Infinity, Infinity),
            new Box(-Infinity, Infinity, 10, Infinity)
